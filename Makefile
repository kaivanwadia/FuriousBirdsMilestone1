...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Mon Oct 20 00:44:35 2014
# Project:  birds.pro
# Template: app
...
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -L/usr/X11R6/lib -lGLU -L/v/filer4b/v20q001/vismay/FuriousBirdsMilestone1/SOIL/lib -lSOIL -lQtOpenGL -lQtGui -lQtCore -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
libSOIL:
	cd /v/filer4b/v20q001/vismay/FuriousBirdsMilestone1/SOIL/projects/makefile/ && make
