...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Sun Oct 19 17:56:26 2014
# Project:  birds.pro
# Template: app
...
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -L/usr/X11R6/lib -lGLU -L/v/filer4b/v20q001/kwadia/PhysicalSimCS395T/BirdsMilestone1/FuriousBirdsMilestone1/SOIL/lib -lSOIL -lQtOpenGL -lQtGui -lQtCore -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/birds1.0.0/ && $(COPY_FILE) --parents mainwindow.h glpanel.h controller.h simulation.h simparameters.h mesh.h rigidbodytemplate.h rigidbodyinstance.h vectormath.h camera.h rotator.h .tmp/birds1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp glpanel.cpp controller.cpp simulation.cpp simparameters.cpp mesh.cpp rigidbodytemplate.cpp rigidbodyinstance.cpp vectormath.cpp camera.cpp rotator.cpp .tmp/birds1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/birds1.0.0/ && (cd `dirname .tmp/birds1.0.0` && $(TAR) birds1.0.0.tar birds1.0.0 && $(COMPRESS) birds1.0.0.tar) && $(MOVE) `dirname .tmp/birds1.0.0`/birds1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/birds1.0.0
...
libSOIL:
	cd /v/filer4b/v20q001/kwadia/PhysicalSimCS395T/BirdsMilestone1/FuriousBirdsMilestone1/SOIL/projects/makefile/ && make
